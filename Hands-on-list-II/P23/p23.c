...
Name: Jaimin Jadvani
Roll No.: MT2024064
Program Description: Write a program to print the maximum number of files can be opened within a process and size of a pipe (circular buffer).
...
jaimin@Ubuntu-VM:~/Desktop/Software-Systems/Hands-on-list-II/P23$ gcc p23.c -o p23
jaimin@Ubuntu-VM:~/Desktop/Software-Systems/Hands-on-list-II/P23$ ./p23 
