...
Name: Jaimin Jadvani
Roll No.: MT2024064
Program Description: Write a program to create a concurrent server.
...
jaimin@Ubuntu-VM:~/Desktop/Software-Systems/Hands-on-list-II/P34$ gcc -pthread p34ServerB.c -o ServerB
jaimin@Ubuntu-VM:~/Desktop/Software-Systems/Hands-on-list-II/P34$ ./ServerB
