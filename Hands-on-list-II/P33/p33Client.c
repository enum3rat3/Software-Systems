...
jaimin@Ubuntu-VM:~/Desktop/Software-Systems/Hands-on-list-II/P33$ gcc p33Client.c -o client
jaimin@Ubuntu-VM:~/Desktop/Software-Systems/Hands-on-list-II/P33$ ./client 
