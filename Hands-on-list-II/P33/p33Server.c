...
Name: Jaimin Jadvani
Roll No.: MT2024064
Program Description: Write a program to communicate between two machines using socket.
...
jaimin@Ubuntu-VM:~/Desktop/Software-Systems/Hands-on-list-II/P33$ gcc p33Server.c -o server
jaimin@Ubuntu-VM:~/Desktop/Software-Systems/Hands-on-list-II/P33$ ./server 
