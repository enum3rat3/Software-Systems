...
Name: Jaimin Jadvani
Roll No.: MT2024064
Program Description: Write a program to change the exiting message queue permission. (use msqid_ds structure)
...
int main()
{
    ...
    messageQueueInfo.msg_perm.mode = 0700;
...
jaimin@Ubuntu-VM:~/Desktop/Software-Systems/Hands-on-list-II/P28$ gcc p28.c -o p28
jaimin@Ubuntu-VM:~/Desktop/Software-Systems/Hands-on-list-II/P28$ ./p28 
Key: 17105838
