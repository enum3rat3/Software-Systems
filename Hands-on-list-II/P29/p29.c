...
Name: Jaimin Jadvani
Roll No.: MT2024064
Program Description: Write a program to remove the message queue.
...
jaimin@Ubuntu-VM:~/Desktop/Software-Systems/Hands-on-list-II/P29$ gcc p29.c -o p29
jaimin@Ubuntu-VM:~/Desktop/Software-Systems/Hands-on-list-II/P29$ ./p29
