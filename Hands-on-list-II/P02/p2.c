...
jaimin@Ubuntu-VM:~/Desktop/Software-Systems/Hands-on-list-II/P02$ gcc p2.c -o p2
jaimin@Ubuntu-VM:~/Desktop/Software-Systems/Hands-on-list-II/P02$ ./p2 
...
Maximum  number of bytes of memory that may be locked into RAM: 67108864
