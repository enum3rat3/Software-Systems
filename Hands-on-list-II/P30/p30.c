...
Name: Jaimin Jadvani
Roll No.: MT2024064
Program Description: Write a program to create a shared memory.
...
====================== Reading =======================
jaimin@Ubuntu-VM:~/Desktop/Software-Systems/Hands-on-list-II/P30$ gcc p30.c -o p30
jaimin@Ubuntu-VM:~/Desktop/Software-Systems/Hands-on-list-II/P30$ ./p30 
